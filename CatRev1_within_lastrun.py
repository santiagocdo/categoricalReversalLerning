...
# Use the id of the string vector as the seed for randomness
seed = id(string_vector)

# Define a custom hash function using Python's built-in hash() function
def custom_hash(value):
    return hash(value)

# Get the index of the randomly selected element using the custom hash function
random_index = custom_hash(seed) % len(string_vector)

# Retrieve the randomly selected element
